...
const CategoryView = ({ category, initialProducts }: CategoryViewProps) => {
    ...
    }, [initialProducts, motorisierungFilter, windschutzFilter]);
                            ...
                            >
                                ...
                                <CardContent className="p-6 space-y-4">
                                    ...
                                    <Button variant="link" asChild className="p-0 h-auto text-accent">
                                        <a href={`/produkt/${product.slug}`} className="flex items-center gap-2">
                                            Details ansehen
                ...
                <div className="container">
                    <div className="max-w-3xl mx-auto text-center text-white">
                        ...
                        <Button size="lg" variant="secondary" asChild>
                            <a href="/kontakt?type=beratung">Jetzt Beratung anfragen</a>
                        </Button>
                    </div>
                </div>
            </section>
