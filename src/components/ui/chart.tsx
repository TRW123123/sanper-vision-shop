...
type ChartTooltipItem = Payload<ValueType, NameType>;
...
>(
  (
    ...
    const tooltipPayload = payload as ReadonlyArray<ChartTooltipItem>;
...
function formatChartValue(value: ValueType) {
  return Array.isArray(value) ? value.join(", ") : value.toLocaleString();
}
