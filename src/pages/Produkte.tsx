...
const Produkte = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Produkte – Sanper Gölgelendirme Systeme</title>
        <meta
          name="description"
          content="Entdecken Sie unser umfassendes Sortiment: Pergola-Systeme, Verglasungssysteme, Textile Beschattung, Transparente Schutzsysteme und Innenraum-Lösungen."
        />
        <meta property="og:title" content="Produkte – Sanper Gölgelendirme Systeme" />
        <meta
          property="og:description"
          content="Entdecken Sie unser umfassendes Sortiment: Pergola-Systeme, Verglasungssysteme, Textile Beschattung, Transparente Schutzsysteme und Innenraum-Lösungen."
        />
        <link rel="canonical" href="https://sanper.de/produkte" />
      </Helmet>
                ...
                >
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <Button variant="link" asChild className="p-0 h-auto text-accent">
                      <Link to={`/produkte/${category.id}`} className="flex items-center gap-2">
                        Produkte ansehen
            ...
            <div className="max-w-3xl mx-auto text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" variant="secondary" asChild>
                  <Link to="/kontakt?type=beratung">Beratungstermin vereinbaren</Link>
                </Button>
